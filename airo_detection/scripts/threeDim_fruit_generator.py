...
class LidarReprojector:
    def __init__(self):
        ...
        self.ts = message_filters.ApproximateTimeSynchronizer([self.sub_lidar, self.sub_image, self.sub_odom], 30, 0.055)
    ...
    def callback(self, lidar_msg, image_msg, odom_msg):
        ...
        # fruit_point = PointStamped()
            ...
            if(not has_valid_depth):
                ...
                mode_depth = self.find_mode_depth(knn_points, 60)
                ...
                if(fruit_depth > 1 and fruit_depth < 10):
                    ...
                    cv2.putText(image_with_lidar_points, 'this fruit is invalid', position, font, font_scale, color_r, thickness=2)
